...
export const ECOMMERCE_TAGS = {
  ...
  EC_CLIENTE_RECORRENTE: "EC_CLIENTE_RECORRENTE",
  EC_CLIENTE_INATIVO: "EC_CLIENTE_INATIVO",
...
export const JOURNEY_STAGE_MAP: Record<string, { add: string[]; remove: string[] }> = {
  ...
  c1: { add: [JOURNEY_TAGS.J02_CONSIDERACAO, "C_PRIMEIRO_CONTATO"], remove: [JOURNEY_TAGS.J01_CONSCIENCIA] },
  c2: { add: [JOURNEY_TAGS.J02_CONSIDERACAO], remove: [JOURNEY_TAGS.J01_CONSCIENCIA] },
  c3: { add: [JOURNEY_TAGS.J02_CONSIDERACAO], remove: [JOURNEY_TAGS.J01_CONSCIENCIA] },
  sdr_nutricao: { add: [JOURNEY_TAGS.J02_CONSIDERACAO], remove: [JOURNEY_TAGS.J01_CONSCIENCIA] },
  ...
  ltv: { add: [JOURNEY_TAGS.J04_COMPRA, "C_CONTRATO_FECHADO"], remove: [JOURNEY_TAGS.J03_NEGOCIACAO] },
