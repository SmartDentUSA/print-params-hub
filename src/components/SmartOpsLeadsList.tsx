...
import { Search, Download, ChevronLeft, ChevronRight, X, Send, Loader2, ShoppingBag, CalendarDays, UserRoundCheck } from "lucide-react";
  ...
  return (
    <div className={`intel-lead-row ${active ? "active" : ""}`} onClick={onClick}>
      ...
      <div className="intel-lr-mid">
        {hasLojaPurchase && (
          <span className="intel-lr-tag intel-tag-store" title="Cliente com compra na Loja Integrada">
            <ShoppingBag size={11} aria-hidden="true" /> Loja
          </span>
        )}
