...
.kbs-nav-btn.on{background:#363E56;color:#fff;font-weight:600;}
...
.kbs-nav-btn.cat.on .kbs-count{background:#363E56;color:#fff;}
...
.kbs-toptab.on{background:#363E56;color:#fff;}
