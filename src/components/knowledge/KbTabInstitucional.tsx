...
const C = {
  pt: {
    ...
    h1a: 'Tecnologia de precisão', h1b: 'para a odontologia', h1c: 'digital.',
    lead: 'A Smart Dent reúne scanners intraorais de alta precisão e impressão 3D em um único fluxo odontológico digital completo. De implantes a próteses, nossas soluções dão a clínicas e laboratórios a segurança para decidir melhor e entregar resultados superiores aos pacientes.',
  ...
  en: {
    ...
    h1a: 'Precision technology', h1b: 'for digital', h1c: 'dentistry.',
    lead: 'Smart Dent brings high-precision intraoral scanners and 3D printing together in one complete digital dental workflow. From implants to prosthetics, our solutions give clinics and labs the confidence to decide better and deliver superior outcomes for patients.',
  ...
  es: {
    ...
    h1a: 'Tecnología de precisión', h1b: 'para la odontología', h1c: 'digital.',
    lead: 'Smart Dent reúne escáneres intraorales de alta precisión e impresión 3D en un único flujo dental digital completo. De implantes a prótesis, nuestras soluciones dan a clínicas y laboratorios la seguridad para decidir mejor y lograr resultados superiores para los pacientes.',
