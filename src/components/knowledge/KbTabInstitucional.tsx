...
const C = {
  pt: {
    ...
    h1a: 'Insumos fabricados', h1b: 'para a odontologia', h1c: 'digital.',
    lead: 'A Smart Dent fabrica insumos para odontologia digital e integra scanners intraorais, softwares e impressoras 3D em fluxos laboratoriais e clínicos completos — do escaneamento à entrega do caso.',
  ...
  en: {
    ...
    h1a: 'In-house supplies', h1b: 'for digital', h1c: 'dentistry.',
    lead: 'Smart Dent manufactures digital dentistry supplies and integrates intraoral scanners, software and 3D printers into complete laboratory and clinical workflows — from scan to case delivery.',
  ...
  es: {
    ...
    h1a: 'Insumos fabricados', h1b: 'para la odontología', h1c: 'digital.',
    lead: 'Smart Dent fabrica insumos para odontología digital e integra escáneres intraorales, software e impresoras 3D en flujos de laboratorio y clínicos completos — del escaneo a la entrega del caso.',
