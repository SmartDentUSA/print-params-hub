  ...
  return (
    <div className="space-y-5">
      ...
      {persisted && <div className="space-y-4">
        <div className="flex items-center justify-between"><div><h3 className="font-semibold">Seções do combo</h3><p className="text-sm text-muted-foreground">Organize equipamentos, consumíveis, serviços, treinamentos ou qualquer outra composição.</p></div><div className="flex items-center gap-3">{sections.length >= 5 && <p className="text-xs text-muted-foreground">Limite de 5 combos atingido</p>}<Button variant="outline" onClick={addSection} disabled={sections.length >= 5}><Plus className="mr-2 h-4 w-4" />Adicionar combo</Button></div></div>
