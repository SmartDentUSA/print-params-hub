...
export const LIA_SYSTEM_FIELDS: { value: string; label: string }[] = [
  ...
  { value: "empresa_custom_fields", label: "Empresa Campos Custom" },
  ...
  { value: "intelligence_score_total", label: "Intelligence Score Total" },
  ...
  { value: "piperun_closed_at", label: "PipeRun Fechado Em" },
  { value: "piperun_created_at", label: "PipeRun Criado Em" },
  { value: "piperun_custom_fields", label: "PipeRun Campos Custom" },
  { value: "piperun_deleted", label: "PipeRun Deletado" },
  { value: "piperun_description", label: "PipeRun Descrição" },
  { value: "piperun_frozen", label: "PipeRun Congelado" },
  { value: "piperun_frozen_at", label: "PipeRun Congelado Em" },
  { value: "piperun_hash", label: "PipeRun Hash" },
  { value: "piperun_id", label: "PipeRun ID" },
  { value: "piperun_last_contact_at", label: "PipeRun Último Contato" },
  { value: "piperun_lead_time", label: "PipeRun Lead Time" },
  { value: "piperun_link", label: "PipeRun Link" },
  { value: "piperun_observation", label: "PipeRun Observação" },
  { value: "piperun_origin_id", label: "PipeRun Origin ID" },
  { value: "piperun_origin_name", label: "PipeRun Origin Name" },
  { value: "piperun_owner_id", label: "PipeRun Owner ID" },
  { value: "piperun_pipeline_id", label: "PipeRun Pipeline ID" },
  { value: "piperun_pipeline_name", label: "PipeRun Pipeline Name" },
  { value: "piperun_probability", label: "PipeRun Probabilidade" },
  { value: "piperun_probably_closed_at", label: "PipeRun Previsão Fechamento" },
  { value: "piperun_stage_changed_at", label: "PipeRun Data Mudança Etapa" },
  { value: "piperun_stage_id", label: "PipeRun Stage ID" },
  { value: "piperun_stage_name", label: "PipeRun Etapa" },
  { value: "piperun_status", label: "PipeRun Status" },
  { value: "piperun_title", label: "PipeRun Título" },
  { value: "piperun_value_mrr", label: "PipeRun Valor MRR" },
  ...
  { value: "proactive_count", label: "Proactive Count" },
  { value: "proactive_sent_at", label: "Proactive Enviado Em" },
  { value: "produto_interesse_auto", label: "Produto Interesse Auto" },
  { value: "proposals_data", label: "Propostas Data (JSON)" },
  { value: "proposals_last_status", label: "Propostas Último Status" },
  { value: "proposals_total_mrr", label: "Propostas Total MRR" },
  { value: "proposals_total_value", label: "Propostas Total Valor" },
  ...
  { value: "resumo_historico_ia", label: "Resumo Histórico IA" },
  { value: "reuniao_agendada", label: "Reunião Agendada" },
  { value: "rota_inicial_lia", label: "Rota Inicial LIA" },
  ...
  { value: "status_atual_lead_crm", label: "Status Atual Lead CRM" },
