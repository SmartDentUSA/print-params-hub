...
- Ficha completa no arquivo do Drive (uso interno, nunca no artigo público): nome completo, telefone, e-mail, Instagram, cidade/UF, empresa/CNPJ, especialidade/área, vendedor (owner do deal), curso/turma, data do treinamento, origem de campanha e de primeiro contato, entrada no funil Vendas → entrada no funil CS + lead time em dias, NPS respondido (3 notas, data e comentário), primeira/última compra, itens comprados (deals ganhos + pedidos e-commerce), faturamento Omie, LTV e-commerce, proposta/contrato/NF/entrega.
